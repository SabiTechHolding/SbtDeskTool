/* eslint-disable */
// Generated by Wrangler by running `wrangler types D:\Projects\sbt-desktool\src-admin\sync-api\worker-configuration.d.ts --config D:\Projects\sbt-desktool\src-admin\sync-api\wrangler.jsonc` (hash: e3fa3db5857a8aa2e80bebce77623e33)
// Runtime types generated with workerd@1.20260515.1 2026-05-22 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	SYNC_WORKSPACE_ID: "sabitech";
	ALLOW_LEGACY_SYNC_TOKEN: "false";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SYNC_WORKSPACE_ID" | "ALLOW_LEGACY_SYNC_TOKEN">> {}
}
