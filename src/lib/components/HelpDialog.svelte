<script lang="ts">
  ...
  const shortcuts = [
    ...
    ["F3 / Shift + F3", "Find next / previous result"],
    ["Ctrl + F3 / Ctrl + Shift + F3", "Find next / previous selected text"],
    ["Ctrl + F2 / F2 / Shift + F2", "Toggle / next / previous bookmark"],
    ["Ctrl + Shift + F2", "Clear all bookmarks in the focused text area"],
    ["Ctrl + G / Ctrl + H", "Go to line / Replace"],
    ["Ctrl + D", "Duplicate the current line or selected lines"],
    ["Ctrl + L / Ctrl + Shift + L", "Cut / delete the current line"],
    ["Ctrl + Shift + ↑ / ↓", "Move the current line or selected lines"],
    ["Ctrl + J", "Join selected lines"],
    ["Ctrl + Q / Ctrl + Shift + Q", "Toggle line / block comment"],
    ["Ctrl + U / Ctrl + Shift + U", "Convert selection to lower / upper case"],
    ["Ctrl + B", "Jump to the matching bracket"],
